"""
Django settings for saqfeederdata project.
...
SECRET_KEY = 'django-insecure-ta&=d_9+l=hs0drbtbo137)t$h_5zp8_@z%(y7juc8+!6^2i*v'
...
ROOT_URLCONF = 'saqfeederdata.urls'
...
WSGI_APPLICATION = 'saqfeederdata.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ BASE_DIR / 'dataapi/static/' ]
